...
export function getOrCreateSession({ session_id, ip, geo, ttl = DEFAULT_TTL }) {
  ...
  const session = {
    ...
    ip,
    geo: geo || { country: null, region: null, city: null }
  };
...
export function listSessions() {
  return [...storage.sessions.values()].map(s => ({
